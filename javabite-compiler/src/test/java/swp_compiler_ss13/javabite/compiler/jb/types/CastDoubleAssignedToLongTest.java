...
public class CastDoubleAssignedToLongTest extends AbstractCompilerTest {

	@Override
	public String getProgFile() {
		return "jb" + File.separator + "types" + File.separator + "cast_type_mismatch_decl_assign_long_double.prog";
	}
