...
public class ErrorLongAssignedToBooleanTest extends AbstractCompilerTest {

	@Override
	public String getProgFile() {
		return "jb" + File.separator + "types" + File.separator + "error_type_mismatch_decl_assign_boolean_long.prog";
	}
