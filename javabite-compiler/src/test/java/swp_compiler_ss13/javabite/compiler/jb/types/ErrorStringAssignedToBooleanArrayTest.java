...
@Ignore
public class ErrorStringAssignedToBooleanArrayTest extends AbstractCompilerTest {

	@Override
	public String getProgFile() {
		return "jb" + File.separator + "types" + File.separator + "error_type_mismatch_array_decl_assign_boolean_string.prog";
	}
