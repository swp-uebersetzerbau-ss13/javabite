...
public class WhileHeadWithCompareLessEquals3 extends AbstractCompilerTest{
	
	@Override
	public String getProgFile() {
		return "jb" + File.separator + "while_" + File.separator + "while_head_with_compare_less_equals_3.prog";
	}
