...
public class LongAssignedToStringArrayTest extends AbstractCompilerTest {

	@Override
	public String getProgFile() {
		return "jb" + File.separator + "types" + File.separator + "array_decl_assign_string_long.prog";
	}
