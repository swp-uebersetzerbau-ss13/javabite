...
public class ErrorStringAssignedToDoubleTest extends AbstractCompilerTest {

	@Override
	public String getProgFile() {
		return "jb" + File.separator + "types" + File.separator + "error_type_mismatch_decl_assign_double_string.prog";
	}
