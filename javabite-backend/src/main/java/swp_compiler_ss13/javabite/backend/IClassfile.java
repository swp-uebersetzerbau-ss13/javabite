...
public interface IClassfile {
	...
	/**
	 * <h1>ExternalConstantTypes</h1>
	 * <p>
	 * This enumeration defines the available types for entries in the constant
	 * pool of a classfile, which can be generated by external methods via the
	 * classfile method "addConstantToConstantPool".
	 * </p>
	 * 
	 * @author Eike
	 * @since May 12, 2013 4:52:43 PM
	 * @see Classfile#addConstantToConstantPool(ConstantType, String)
	 */
