 ...
 * <h1>Mnemonic-enum</h1>
 * <p>
 * This enum holds all available bytecode mnemonics and their respective bytecode bytes.
 * </p>
 * 
 * @author eike
...
public enum Mnemonic {
	...
	/**
	 * Returns the mnemonic name of this bytecode operation. The mnemonic will be returned in all uppercase letters, because the enum-method name() is used to
	...
	public static Mnemonic getMnemonic(final String prefix, final int value) {
		try {
			final String name = prefix + "_" + (value == -1 ? "M1" : Integer.toString(value));
