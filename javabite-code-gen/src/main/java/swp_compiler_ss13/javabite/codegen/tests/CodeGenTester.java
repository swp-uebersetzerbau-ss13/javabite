...
public class CodeGenTester {
	...
	public static void main(String[] args){
		...
		IntermediateCodeGeneratorJb codegen = new IntermediateCodeGeneratorJb();
		try {
			codegen.generateIntermediateCode(ast);
			System.out.println("Size "+IntermediateCodeGeneratorJb.quadruples.size());
			for(Quadruple quad : IntermediateCodeGeneratorJb.quadruples){
